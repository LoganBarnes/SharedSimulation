...
function( DownloadProject projectName )
  ...
  configure_file( cmake/CMakeLists.txt.${projectName} ${CMAKE_BINARY_DIR}/${projectName}-download/CMakeLists.txt )
  execute_process( COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" .
    RESULT_VARIABLE result
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/${projectName}-download )
  if( result )
